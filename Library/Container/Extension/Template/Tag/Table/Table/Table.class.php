...
class ContainerExtensionTemplateTagTableTable extends Base
{
    ...
    public function get(): string
    {
        ...
        $templateContainer->assign('tableClass',
                                   'ContainerExtensionTemplateTagTableTable ' . $this->tableClass);
        ...
        foreach ($this->data as $dataItem) {
            ...
            foreach ($this->configRow as $configRowKey => $configRowItem) {
                ...
                if (isset($configRowItem['rowParameter']) && !empty($configRowItem['rowParameter'])) {
                    $rowParameter = explode('|',
                                            $configRowItem['rowParameter']);

                    foreach ($rowParameter as $modificationWorkItem) {
                        ...
                        /** @var ContainerExtensionTemplateTagTableTable_abstract_modification $object */
                        $object = Container::getInstance('ContainerExtensionTemplateTagTableTable' . ucfirst($modificationWorkItemClass));
